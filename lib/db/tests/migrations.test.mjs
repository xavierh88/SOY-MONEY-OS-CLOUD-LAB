...
const migrationNames = [
  ...
  "20260920_evidence_schema_alignment.sql",
  "20260921_missing_core_schema.sql",
  "20260922_projects_schema_alignment.sql",
  "20260923_human_actions_idempotency.sql",
  "20260924_finance_ledger_idempotency.sql",
  "20260925_candidate_decision_constraints_alignment.sql",
  "20260926_autonomous_cycles_schema_alignment.sql",
  "20260927_monetization_attempts_schema_alignment.sql",
  "20260928_discovery_temporal_model.sql",
  "20260929_market_cycles_github_run_url_alignment.sql",
  "20260930_market_forward_learning.sql",
  "20261001_market_forward_dedupe.sql",
];
